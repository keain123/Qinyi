    ...
    public void initStatic() {
        ...
        RoundRectDrawableWithShadow.sRoundRectHelper
            ...
            public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius,
                    Paint paint) {
                final float twoRadius = cornerRadius * 2 + 1f; // subtracted 1
                ...
                canvas.drawRect(bounds.left + cornerRadius, bounds.top,
                        bounds.right - cornerRadius, bounds.top + cornerRadius + 0.5f,
                        paint);
                canvas.drawRect(bounds.left + cornerRadius,
                        bounds.bottom - cornerRadius - 0.5f, bounds.right - cornerRadius, // subtracted 0.5
                        bounds.bottom, paint);
